              ...
              {NAV_LINKS.map((link) => {
                ...
                return (
                  <Link
                    ...
                    href={link.href}
                    onClick={() => setIsOpen(false)}
                    className="flex items-center justify-between rounded-lg p-4 text-base font-semibold transition-all active:bg-gray-50"
                    style={{
                      color: isActive ? "var(--nav-hover)" : "var(--nav-text)",
                      backgroundColor: isActive
                        ? "rgba(var(--nav-hover-rgb), 0.05)"
                        : "transparent",
                    }}
                  >
                    {link.label}
